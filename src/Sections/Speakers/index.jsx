    ...
    <PageLayout>
      <ContainerWithBackground>
        <SpeakersSection className="flex-column align-items-center">
          <div
            className="intro-text text-justify d-flex flex-column align-items-center"
          ...
          <ApplySection className="d-flex">
            <div className="d-flex flex-column align-items-start justify-content-between">
              <Heading fontSize="3em">APPLY AS SPEAKER</Heading>
              <Button variant="outline">
                <Heading fontSize="1.5em" color={theme.colors.secondary}>Apply Here ></Heading>
              </Button>
            </div>
            <div>
              <Text fontSize="1.5em">
