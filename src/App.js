            ...
            <div className="container h-full">
                <div className="d-flex justify-content-center align-items-center h-full">
                    <div className="app-wrap">
                        ...
                        <p className="app-sub text-center font-size-150 font-size-md-180 font-size-lg-230 font-size-xl-300 text-white alegreya-regular mb-0">11.11.2022 | Legazpi, City</p>
                    </div>
                </div>
            </div>
        </section>
